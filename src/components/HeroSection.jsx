    ...
    return (
        <motion.div
            ...
            <div className="w-full px-4 mt-20 relative">
                ...
                <svg 
                className="hidden md:block absolute   left-1/3 top-[50em] lg:w-[766px] lg:h-[766px] md:w-[500px] md:h-[500px]"
                width="766" height="766" viewBox="0 0 766 766" fill="none" xmlns="http://www.w3.org/2000/svg">
