                    ...
                    <div className=' w-full md:w-[70%]  flex justify-start items-center '>
                        <div className='w-full flex flex-col justify-center gap-y-3 md:gap-y-6'>
                            <p className="font-[400] text-[30px] md:text-[60px] lg:text-[56px] leading-[38px] md:leading-[75px] lg:leading-[76px] font-['Gerbil'] tracking-normal text-left">
                                ...
                                <span className="relative inline-block pb-2 md:pb-7 md:mr-10 md:ml-10 mr-4 ml-4">
                                    Tomorrow
                                    <svg
                                ...
                                <span className="relative inline-block mx-1 lg:mx-10">
                                    <span className="relative z-10 px-3">today</span>
                                    <svg
                                        className="absolute left-[20px] md:left-[30px] lg:left-[25px] top-1/2 lg:top-[45px] -translate-y-1/2 -translate-x-[15%] w-full  lg:w-[4.2em] h-[1.2em] rounded-full z-0"
                                        viewBox="0 0 456 109"
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className=' w-full  flex flex-col justify-center gap-y-3 md:gap-y-6'>
                            <p className="font-[400] text-[30px] md:text-[60px] lg:text-[56px] leading-[38px] md:leading-[75px] lg:leading-[76px] font-['Gerbil'] tracking-normal text-left">
                                ...
                                <span className="relative inline-block mx-2 lg:mx-10">
                                    <span className="relative z-10 px-3">See</span>
                                    <svg
                                        className="absolute left-[15px] md:left-[30px] lg:left-[25px] top-1/2 lg:top-[45px] -translate-y-1/2 -translate-x-[15%] w-full  lg:w-[3.2em] h-[1.2em] rounded-full z-0"
                                        viewBox="0 0 456 109"
                                        fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                        preserveAspectRatio="none"
