...
const Footer = () => {
    ...
    return (
        <motion.div
            ...
            className='flex flex-col justify-center items-center w-full mx-auto relative md:mt-22 lg:mt-42 bg-[#D7EEDD]'>
            ...
            <motion.svg
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className="absolute md:right-10 md:top-50 lg:w-[183px] lg:h-[228px] md:w-[100px] md:h-[125px]  w-[50px] h-[60px] rotate-[-5deg] top-40 right-5 object-contain"
            ...
            <div className="flex flex-col items-center justify-center w-full md:w-[70%] p-8 md:p-12 mt-23 md:mt-13">
                ...
                <motion.h1
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    className="font-[400] text-[25px] md:text-[50px] lg:text-[100px] leading-[38px] md:leading-[75px] lg:leading-[116px] font-['Gerbil'] tracking-normal text-center mb-10">
                    Subscribe to
                    our newsletter
                </motion.h1>
                ...
                <motion.p
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    className="text-center text-sm md:text-base lg:text-[24px] lg:leading-[36px] font-['Satoshi-Regular'] tracking-normal mb-10">
            ...
            <motion.hr
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className='w-[90%] border-t-2 border-gray-500 mb-12 mt-5' />
                        ...
                        footer.map((item, index) => (
                            ...
                            >
                                <motion.h3
                                    ...
                                    whileInView={{ opacity: 1, y: 0 }}
                                    transition={{ duration: 0.8, ease: "easeOut" }}
                                    className="lg:text-[22px] lg:leading-[30px] font-['Gerbil'] mb-10 ">{item.title}</motion.h3>
                                <ul>
                                    {
                                        item.links.map((link, index) => (
                                            <motion.li key={index}
                                                ...
                                                whileInView={{ opacity: 1, y: 0 }}
                                                transition={{ duration: 0.8, ease: "easeOut" }}
                                                className="lg:text-[22px] lg:leading-[30px] font-['Satoshi-Regular'] mb-5 cursor-pointer hover:text-gray-700 transition-colors duration-300 ease-in-out">
                                                {link}
                                            </motion.li>
                                        ))
                                    }
            ...
            <div className="flex justify-center mt-10">
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut"}}
                className="lg:text-[18px] lg:leading-[30px] font-['Satoshi-Regular'] text-center mb-5">
